...
API for the Integration Factor app (albums, tracks, auth, contact, cover proxy). See the main [deployment plan](../Integration-Factor/docs/DEPLOYMENT_PLAN.md) and [TASKS](../Integration-Factor/docs/TASKS.md).
